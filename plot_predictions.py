...
dim = "1"
BALD_PATH = "/Users/darpa/prog/dev/psychopy-active-learner/%s/" % mapping["fake_human_BALD_1"]
RANDOM_PATH = "/Users/darpa/prog/dev/psychopy-active-learner/%s/" % mapping["fake_human_random_1"]
...
BALD_human = "%s/BALD_%s_trials" % (mapping["fake_human_BALD_1"], dim)
random_human = "%s/Random_%s_trials" % (mapping["fake_human_random_1"], dim)
